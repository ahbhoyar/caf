...
# FIXED PATH: Using the local project folder to prevent permission errors
DB_FILE = "./caf_state.db"

def init_db():
    # Automatically handle folder setup safely
...
def sync_to_google_sheet(phone: str, service: str, lang: str, notes: str):
    try:
        ...
        if not creds_json: 
            print("⚠️ GOOGLE_CREDENTIALS_JSON is empty or not set.")
            return
        ...
        print(f"📊 Successfully logged row for {phone} to Google Sheets.")
